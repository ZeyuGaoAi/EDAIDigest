  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .panel {{
      ...
      border-radius: 24px;
      padding: 22px;
      box-shadow: 0 10px 24px rgba(22, 33, 43, 0.05);
    }}
    .draft-list {{
      display: grid;
      gap: 14px;
...
<body>
  <div class="wrap">
    <section class="hero">
      ...
      <h1>AI for Early Cancer History Page</h1>
      <p class="muted">A public-facing archive of historical items and daily digest drafts. Generated from the local review database and draft files.</p>
    ...
    <div class="grid">
      <section class="panel">
        <h2>Daily Digest Archive</h2>
        <p class="muted">Each section below reflects a saved draft from the daily workflow.</p>
        <div class="draft-list">{drafts_html}</div>
      </section>

      <section class="panel">
        <h2>Historical Item Database</h2>
        <p class="muted">Search by title or source, or filter by category and status.</p>
        <div class="controls">
